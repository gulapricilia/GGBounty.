...
export function FromAny(any: any): [any | null, string | null, IPluginError | null] {
    ...
    try {
        ...
        if (typeUrl.includes('MessageCreateBounty')) {
            return [types.MessageCreateBounty.decode(any.value), 'MessageCreateBounty', null];
        }
        if (typeUrl.includes('MessageJoinBounty')) {
            return [types.MessageJoinBounty.decode(any.value), 'MessageJoinBounty', null];
        }
        if (typeUrl.includes('MessageSubmitWork')) {
            return [types.MessageSubmitWork.decode(any.value), 'MessageSubmitWork', null];
        }
        if (typeUrl.includes('MessageSelectWinner')) {
            return [types.MessageSelectWinner.decode(any.value), 'MessageSelectWinner', null];
        }
